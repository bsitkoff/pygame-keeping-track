# This Assignment: Lesson 4 — Keeping Track

PRIMM lesson on game state management. `track.py` demonstrates global variables, score tracking, game states (start/playing/game_over), and screen.draw.text().

**Student files**: `track.py` (example), `tryit.py` (student work), `images/`
**Key concepts**: global keyword, score/state variables, screen.draw.text(), on_key_down()
